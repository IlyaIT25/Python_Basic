...
# print(numbers[:])
# print(numbers[1:])
# print(numbers[1:5])  # 1 <= index < 5 (от 1 до 4)
# print(numbers[:5])  # 0 <= index < 5 (от 0 до 4)
# print(numbers[1:5:2])  # промежуток значений по индексам от 1 до 4 так как 5 не
# учитывается (каждый второй элемент -> 2)
# print(numbers[::-1])  # промежуток значений по индексам от последнего до 0 (с конца в начало -> -1)
# print(numbers[5::-1]) # промежуток значений по индексам от 5 до 0 (с конца в начало -> -1)
# print(numbers[5:1:-1])  # промежуток значений по индексам от 5 до 0 так как 1 не учитывается (с конца в начало -> -1)
