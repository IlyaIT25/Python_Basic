...
class Rectangle:
    ...
    def __add__(self, other):
        if isinstance(other, Rectangle):
            ...
            new_width = math.sqrt(new_square)  # Підбираємо сторони
            new_height = new_square / new_width
            return Rectangle(new_width, new_height)
        raise ValueError("Можна додавати лише екземпляри класу Rectangle")
    ...
    def __mul__(self, n):
        if isinstance(n, (int, float)) and n > 0:
            ...
            new_height = new_square / new_width
            return Rectangle(new_width, new_height)
        raise ValueError("Множити можна лише на додатнє число")
